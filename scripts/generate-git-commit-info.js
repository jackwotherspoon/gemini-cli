...
const cliGitCommitFile = join(generatedCliDir, 'git-commit.js');
const generatedCoreDir = join(root, 'packages/core/src/generated');
const coreGitCommitFile = join(generatedCoreDir, 'git-commit.js');
...
writeFileSync(cliGitCommitFile.replace('.js', '.d.ts'), declarationContent);
writeFileSync(coreGitCommitFile, fileContent);
writeFileSync(coreGitCommitFile.replace('.js', '.d.ts'), declarationContent);
